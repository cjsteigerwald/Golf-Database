...
public class Splash extends JWindow
{
 ...
 private int duration;  // how long the splash screen will show in milliseconds
  ...
  {
      Color myLightBlue = new Color(162, 206, 255); // Custom color of blue
      ...
      JLabel label = new JLabel(new ImageIcon("src/Resources/golflogo.jpg"));
      JLabel copyrt = new JLabel ("Copyright 2013, Golf Database", JLabel.CENTER);
      copyrt.setFont(new Font("Sans-Serif", Font.BOLD, 12));
      copyrt.setForeground(Color.WHITE);
      content.add(label, BorderLayout.NORTH); // add to JPanel
